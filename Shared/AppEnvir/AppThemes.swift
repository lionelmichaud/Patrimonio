...
struct ChartThemes {
    ...
    struct ChartDefaults {
        static let smallLabelFont  : NSUIFont = .systemFont(ofSize: 12)
        static let largeLabelFont  : NSUIFont = .systemFont(ofSize: 13)
        static let xLargeLabelFont : NSUIFont = .systemFont(ofSize: 14)
        static let smallLegendFont : NSUIFont = .systemFont(ofSize: 11)
        static let largeLegendFont : NSUIFont = .systemFont(ofSize: 13)
        static let titleFont       : NSUIFont = .systemFont(ofSize: 16, weight: .bold)
        static let baloonfont      : NSUIFont = .systemFont(ofSize: 14)
        static let valueFont       : NSUIFont = .systemFont(ofSize: 14)
    }
    ...
    static let pieChartColorsTable  : [NSUIColor] = [#colorLiteral(red  : 0.2745098174, green  : 0.4862745106, blue  : 0.1411764771, alpha  : 1),#colorLiteral(red  : 0.1764705926, green  : 0.4980392158, blue  : 0.7568627596, alpha  : 1),#colorLiteral(red  : 0.7450980544, green  : 0.1568627506, blue  : 0.07450980693, alpha  : 1),#colorLiteral(red  : 0.7254902124, green  : 0.4784313738, blue  : 0.09803921729, alpha  : 1),#colorLiteral(red  : 0.5568627715, green  : 0.3529411852, blue  : 0.9686274529, alpha  : 1),#colorLiteral(red  : 0.9254902005, green  : 0.2352941185, blue  : 0.1019607857, alpha  : 1),#colorLiteral(red  : 1, green  : 0.5212053061, blue  : 1, alpha  : 1),#colorLiteral(red  : 0.2381011844, green  : 0.6540691257, blue  : 0.4755768776, alpha  : 1),#colorLiteral(red  : 0.9411764741, green  : 0.4980392158, blue  : 0.3529411852, alpha  : 1),#colorLiteral(red  : 0.3647058904, green  : 0.06666667014, blue  : 0.9686274529, alpha  : 1),#colorLiteral(red  : 0.1294117719, green  : 0.2156862766, blue  : 0.06666667014, alpha  : 1),#colorLiteral(red  : 0.1411764771, green  : 0.3960784376, blue  : 0.5647059083, alpha  : 1),#colorLiteral(red  : 0.2196078449, green  : 0.007843137719, blue  : 0.8549019694, alpha  : 1),#colorLiteral(red  : 0.2549019754, green  : 0.2745098174, blue  : 0.3019607961, alpha  : 1),#colorLiteral(red  : 0.1686089337, green  : 0.1686392725, blue  : 0.1686022878, alpha  : 1),#colorLiteral(red  : 0.2554336918, green  : 0.1694213438, blue  : 0.0335564099, alpha  : 1)]
    static let riskColorsTable      : [NSUIColor] = [#colorLiteral(red  : 0.1960784346, green  : 0.3411764801, blue  : 0.1019607857, alpha  : 1),#colorLiteral(red  : 0.3411764801, green  : 0.6235294342, blue  : 0.1686274558, alpha  : 1),#colorLiteral(red  : 0.9529411793, green  : 0.6862745285, blue  : 0.1333333403, alpha  : 1),#colorLiteral(red: 0.9372549057, green: 0.3490196168, blue: 0.1921568662, alpha: 1),#colorLiteral(red: 0.7578792735, green: 0, blue: 0, alpha: 1)]
    static let liquidityColorsTable : [NSUIColor] = [#colorLiteral(red: 0.7578792735, green: 0, blue: 0, alpha: 1),#colorLiteral(red : 0.9529411793, green : 0.6862745285, blue : 0.1333333403, alpha : 1),#colorLiteral(red  : 0.1960784346, green  : 0.3411764801, blue  : 0.1019607857, alpha  : 1)]
