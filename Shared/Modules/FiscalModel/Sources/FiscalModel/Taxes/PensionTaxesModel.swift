...
public struct PensionTaxesModel: Codable, NetPensionProviderP {
    ...
    public func netRegimeGeneral(_ brut: Double) -> Double {
        guard brut >= 0.0 else {
            return 0.0
        }
    ...
    ///   - [tout régime](https://www.toutsurmesfinances.com/impots/csg-des-retraites.html#CSG_non_deductible_ou_deductible_la_CSG_sur_les_retraites_est-elle_imposable)
    public func netRegimeAgirc(_ brut: Double) -> Double {
        guard brut >= 0.0 else {
            return 0.0
        }
    ...
    public func socialTaxesRegimeGeneral(_ brut: Double) -> Double {
        guard brut > 0.0 else {
            return 0.0
        }
    ...
    /// charges sociales sur une pension brute du régime général
    /// - Parameter brut: pension brute du régime général
    public func socialTaxesRegimeAgirc(_ brut: Double) -> Double {
        guard brut > 0.0 else {
            return 0.0
        }
    ...
    public func taxable(brut: Double, net: Double) throws -> Double {
        guard brut >= 0.0 else {
            return 0.0
        }
        guard net >= 0.0 else {
    ...
    ///   - [tout régime](https://www.toutsurmesfinances.com/impots/csg-des-retraites.html#CSG_non_deductible_ou_deductible_la_CSG_sur_les_retraites_est-elle_imposable)
    public func csgNonDeductibleDeIrpp(_ brut: Double) -> Double {
        guard brut >= 0.0 else {
            return 0.0
        }
