...
public func lastDayOf(year: Int) -> Date {
    Date.calendar.date(from: DateComponents(year: year, month: 12, day: 31, hour: 23))!
}

public func numberOfDays(from: Date, to: Date) -> DateComponents {
    Date.calendar.dateComponents([.day], from: from, to: to)
}

public func numberOf(_ component: Calendar.Component, from: Date, to: Date) -> DateComponents {
